...
export const GRID_OPTION_META = {
  ...
  persistence: { kind: "boolean-object", update: "options" },
  ...
  datasourceMaxConcurrentRequests: { kind: "number", update: "options" },
  ...
  datasourceRetryJitter: { kind: "number", update: "options" },
