...
对照 AG Grid（社区/企业版）、TanStack Table、Handsontable、vxe-table 的公开能力矩阵，审视 MachTable v0.5.0 的差距与打磨方向。
...
v0.5.0 已覆盖 AG 社区版主要能力与企业版核心高频面（范围操作/分组/树/明细/固定行/变高/无限）。剩余差距集中在：**P0 六项**（多为体验补齐）、**SSRM/Pivot/Canvas** 三大件（按业务需要立项）。建议节奏：P0 → E2E+视觉回归 → P1 按场景取用。
