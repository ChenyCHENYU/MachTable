...
```bash
pnpm add @agile-team/mach-table-vue@^0.18.1
```

React：

```bash
pnpm add @agile-team/mach-table-react@^0.18.1
```

npm / Yarn：

```bash
npm install @agile-team/mach-table-vue@^0.18.1
yarn add @agile-team/mach-table-vue@^0.18.1
```
