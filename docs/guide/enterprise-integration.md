...
```bash
pnpm add @agile-team/mach-table-vue@^0.19.0
```

React：

```bash
pnpm add @agile-team/mach-table-react@^0.19.0
```

npm / Yarn：

```bash
npm install @agile-team/mach-table-vue@^0.19.0
yarn add @agile-team/mach-table-vue@^0.19.0
```
